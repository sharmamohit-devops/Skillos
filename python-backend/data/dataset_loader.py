...
class DatasetLoader:
    ...
    def load_onet_skills(self) -> Dict[str, List[str]]:
        ...
        onet_skills = {
            "Software Developers": [
                "Programming", "Software Development", "Object-Oriented Programming",
                "Database Management", "Web Development", "Mobile Development",
                "Version Control", "Testing", "Debugging", "API Development"
            ],
            "Data Scientists": [
                "Statistical Analysis", "Machine Learning", "Data Mining", "Python",
                "R Programming", "SQL", "Data Visualization", "Big Data", "Predictive Modeling"
            ],
            "Web Developers": [
                "HTML", "CSS", "JavaScript", "Frontend Frameworks", "Backend Development",
                "Database Integration", "Responsive Design", "User Experience", "SEO"
            ],
            "DevOps Engineers": [
                "Cloud Computing", "Containerization", "Infrastructure as Code",
                "CI/CD", "Monitoring", "Security", "Automation", "Linux Administration"
            ],
            "Mobile Developers": [
                "iOS Development", "Android Development", "Cross-platform Development",
                "Mobile UI/UX", "App Store Optimization", "Mobile Security", "Performance Optimization"
            ]
        }
        ...
        sample_jobs = [
            {
                ...
                """,
                "required_skills": ["Python", "Java", "C++", "AWS", "Azure", "GCP", "Docker", "Kubernetes", "PostgreSQL", "Django"],
            ...
            },
            {
                ...
                """,
                "required_skills": ["React", "JavaScript", "TypeScript", "CSS", "HTML", "Git", "Next.js", "GraphQL"],
            ...
            },
            {
                ...
                """,
                "required_skills": ["Python", "R", "Machine Learning", "TensorFlow", "PyTorch", "Pandas", "SQL", "Statistics", "Tableau"],
            ...
            },
            {
                ...
                """,
                "required_skills": ["AWS", "Azure", "Docker", "Kubernetes", "Terraform", "Jenkins", "Python", "Linux", "CI/CD"],
    ...
    def get_skill_cooccurrence_matrix(self) -> pd.DataFrame:
        ...
        logger.info(f"Generated {len(all_skills)}x{len(all_skills)} co-occurrence matrix")
