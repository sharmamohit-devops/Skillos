...
class JDParser:
    ...
    def _extract_role(self, text: str) -> str:
        ...
        role_matches = re.findall(r'(?i)(?:position|role|job title)[:\s]*([^\n\r]+)', text)
        if role_matches:
    ...
    def _extract_domains(self, text: str) -> List[str]:
        ...
        domain_keywords = {
            "Web Development": ["web", "frontend", "backend", "fullstack", "website", "web application"],
            "Mobile Development": ["mobile", "android", "ios", "app development", "react native", "flutter"],
            "Data Science": ["data science", "analytics", "machine learning", "ai", "big data", "data analysis"],
            "Cloud Computing": ["cloud", "aws", "azure", "gcp", "devops", "infrastructure", "saas"],
            "E-commerce": ["ecommerce", "e-commerce", "retail", "online shopping", "marketplace"],
            "Finance": ["fintech", "finance", "banking", "trading", "payments", "blockchain", "cryptocurrency"],
            "Healthcare": ["healthcare", "medical", "health tech", "telemedicine", "clinical"],
            "Education": ["edtech", "education", "learning", "training", "academic"],
            "Gaming": ["gaming", "game development", "unity", "unreal", "entertainment"],
            "Enterprise Software": ["enterprise", "b2b", "saas", "crm", "erp", "business software"],
            "Cybersecurity": ["security", "cybersecurity", "infosec", "penetration testing", "compliance"],
            "IoT": ["iot", "internet of things", "embedded", "sensors", "hardware"],
            "Social Media": ["social media", "social network", "community", "content platform"],
        ...
        if not domains:
            if any(term in text_lower for term in ["software", "developer", "engineer", "programmer"]):
    ...
    def _clean_skill(self, skill: str) -> str:
        ...
        skill = re.sub(r'(?i)^(?:experience (?:with|in)|knowledge of|proficiency (?:with|in)|familiarity with)\s*', '', skill)
        skill = re.sub(r'(?i)\s*(?:is (?:a )?(?:must|required|preferred|plus))$', '', skill)
        ...
        non_skills = ['and', 'or', 'the', 'a', 'an', 'with', 'in', 'of', 'for', 'to', 'is', 'are', 'be', 'have', 'has']
    ...
    def _is_skill_like(self, text: str) -> bool:
        ...
        non_skill_phrases = [
            'we are looking for', 'you will', 'responsibilities include',
            'requirements', 'qualifications', 'what we offer',
            'benefits', 'salary', 'location', 'remote', 'office'
        ]
        ...
        skill_indicators = [
            'experience', 'knowledge', 'proficiency', 'familiar', 'understanding',
            'programming', 'development', 'framework', 'language', 'database',
            'tool', 'technology', 'platform', 'library', 'api'
        ]
