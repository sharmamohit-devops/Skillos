...
class ResumeParser:
    ...
    def _extract_experience_level(self, text: str) -> str:
        ...
        if any(title in text_lower for title in ['senior', 'lead', 'principal', 'staff']):
            return "Senior level (5+ years)"
        elif any(title in text_lower for title in ['junior', 'intern', 'trainee', 'fresher']):
    ...
    def _extract_domains(self, text: str, skills: List[str]) -> List[str]:
        ...
        domain_keywords = {
            ...
            "Data Science": ["data", "analytics", "machine learning", "ai", "statistics", "python", "r"],
